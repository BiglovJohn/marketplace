...
from .views import (AddToCompareList, CompareListView, ItemListView,
                    OrderDeliveryInfoView, OrderPaymentTypeView,
                    OrderSubmitView, OrderUserInfoView, ProductDetailView,
                    ReviewAddView, ReviewsListView, add_to_viewed,
                    delete_from_compare_list, delete_from_viewed, index_page,
                    is_viewed, order_detail, sales_list, seller_detail,
                    viewed_goods, viewed_goods_number)
