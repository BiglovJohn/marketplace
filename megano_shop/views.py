...
from .forms import (ItemsFilterForm, OrderDeliveryInfoForm,
                    OrderPaymentTypeForm, OrderUserInfoForm, ReviewsForm)
from .models import (Banner, Category, Discounts, Item, Order, OrderCart,
                     Reviews, Stock)
...
from .utils.filter_utils import (form_cleaned_data_filters,
                                 form_cleaned_data_sorting)
...
def index_page(request):
    ...
    return render(
        request,
        "index.html",
        {"banners": banners, "top_items": top_items, "limited_offer": limited_offer,
